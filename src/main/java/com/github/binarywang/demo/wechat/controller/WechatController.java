...
public class WechatController {
    ...
    @Autowired//Bean在WechatMpConfigure中定义
    private WxMpService wxService;//注入service

    @Autowired
    private WxMpMessageRouter router;//注入router

    @GetMapping(produces = "text/plain;charset=utf-8")//发来无格式文本
